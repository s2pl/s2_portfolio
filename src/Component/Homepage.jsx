          ...
          <div className="item" id="item1">
            <div className="item-cover ">
              <div className="content" data-aos="fade-down">
                <div className="name">
                  <div className="head-name">SwachDNR App </div>
                </div>
                <div className="des">
                  <h5>
                    Accelerate your Growth with our End-to-End Automation
                    Solutions
                  </h5>
                  <p>
                    We build process automation with seamless integration for
                    optimizing performance
                  </p>
                  <p>
                    Build with us to realize your full organizational potential{" "}
                  </p>
                </div>
              ...
              <div className="img">
                <LazyLoad
                  placeholder={<Skeleton min-width={240} min-height={240} />}
                >
        ...
        <div className="discription-cover">
          <div className="front-intro">
            ...
            <p>
              ...
              Our mission is to bring automation, technology, and innovation to
              simplify complex problems. We add value by increasing efficiency
              and driving data analytics for higher quality standards.
            </p>
            <p>
              Since our inception, we have collaborated with large organizations
              to deploy intelligent automation, resulting in improved turnaround
              times, enhanced service quality, and increased customer
              satisfaction.
            </p>
            <p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              <div className="counter-item text-center mb-5 sm:mb-0">
                <h3 className="mb-0">
                  <span className="counter-text">
                    {count && (
                      <CountUp start={0} end={405} duration={2} delay={0} />
                    )}
                  </span>{" "}
                  +
                </h3>
                <div className="text-sm">Trains: 400</div>
                <div className="text-sm">Stations: 5</div>
                <div className="text-sm">Colonies: WIP</div>
                <div className="text-sm">Hospital: WIP</div>
              ...
              <div className="counter-item text-center mb-5 sm:mb-0">
                <h3 className="mb-0">
                  <span className="counter-text">
                    {count && (
                      <CountUp start={0} end={295} duration={2} delay={0} />
                    )}{" "}
                  </span>
                  +{" "}
                </h3>
                <div className="text-sm">Trains: 200</div>
                <div className="text-sm">Stations: 90</div>
                <div className="text-sm">Colonies: 5</div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 comment">
            <div className="col-span-1 xl:col-span-5 lg:col-span-6">
              <div className="cta-item bg-white p-5 rounded">
                <span className="text-sm text-color">Best Service</span>
                <h2 className="text-2xl mt-2 mb-4">Who We Are?</h2>
                <p className="text-lg mb-4">
                  Have any software required then? For immediate support:
                </p>
                <ul className="service-unlist">
                  ...
                  <li className="service-list">
                    ...
                    AWMS - Automated Water Monitoring System
                  </li>
                  <li className="service-list">
                    <span className="material-symbols-outlined">
                      arrow_circle_right
            ...
            <Slider {...settings_client}>
              <div className="card feedback-card " style={{ width: "15rem;" }}>
                <div className="card-body ">
                  ...
                  <p className="card-text pb-4">
                    Our integrated platform, comprising a website and mobile
                    app, streamlines employee performance record management.{" "}
                  </p>
              ...
              <div className="card feedback-card" style={{ width: "15rem;" }}>
                <div className="card-body ">
                  ...
                  <p className="card-text pb-4">
                    This integrated solution merges embedded systems and
                    software to real-time monitor solar panel efficiency.
                  </p>
      ...
      <div className="government">
        ...
        <div className="govern">
          <div className="govern-card">
            ...
            <p>IIT Patna Incubation Centre</p>
          </div>
          <div className="govern-card">
            <div className="support-img">
              <LazyLoad
