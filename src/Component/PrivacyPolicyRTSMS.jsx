...
const PrivacyPolicyRTSMS = () => {
  return (
    <div style={{ fontFamily: 'Helvetica Neue, Helvetica, Arial, sans-serif', padding: '1em' }}>
      <strong>Privacy Policy</strong>
      <p>
        This privacy policy applies to the Running Train Sanitation Management System (RTSMS) app (hereby referred to as "Application") for mobile devices that was created by Neeta Sinha (hereby referred to as "Service Provider") as a Free service. This service is intended for use "AS IS".
      </p>
      <br />
      ...
      <br />
      <p>This privacy policy is effective as of 2024-07-23</p>
      <br />
      ...
      <hr />
      <p>
        This privacy policy page was generated by <a href="https://app-privacy-policy-generator.nisrulz.com/" target="_blank" rel="noopener noreferrer">App Privacy Policy Generator</a>
      </p>
    </div>
  );
};

export default PrivacyPolicyRTSMS;
